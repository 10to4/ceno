...
impl InsnRecord<()> {
    ...
    pub fn imm_internal(insn: &Instruction) -> i64 {
        insn.imm
        // match (insn, InsnFormat::from(insn.kind)) {
        ...
        //         ..
        //     }, _) => 1 << (insn.imm & 0x1F),
        //     // TODO(Matthias): re-evalute this.  We should be able to just take the immediat
        //     // Unsigned view.
        //     // For example, u32::MAX is `u32::MAX mod p` in the finite field.
        //     (_, Instruction { format: R | U, .. })
        //     | (Instruction {
        //         kind: ADDI | SLTIU | ANDI | XORI | ORI,
        //         ..
        //     }, _) => insn.imm as u32 as i64,
        //     // Signed view.
